            ...
            <li class="nav-item dropdown">
                ...
                <div class="media align-items-center">
                  ...
                  <div class="media-body  ml-2  d-none d-lg-block">
                    <span class="mb-0 text-sm  font-weight-bold">
                      <?php if(!empty($session['userLogin'])){echo $session['userLogin']->nama;}?>
                    </span>
                  </div>
                </div>
              </a>
              <div class="dropdown-menu  dropdown-menu-right ">
                ...
                <span class="dropdown-item">
                  ...
                  <span>
                      <?php if(!empty($session['userLogin'])){echo $session['userLogin']->email;}?>
                  </span>
                </span>
                <span class="dropdown-item">
                  <i class="ni ni-settings-gear-65"></i>
                  <span> 
                      <?php if(!empty($session['userLogin'])){
                        $role = $session['userLogin']->role;
                        if($role == 1){
                          echo "Admin";
                        }elseif ($role == 2) {
                          echo "Pegawai";
